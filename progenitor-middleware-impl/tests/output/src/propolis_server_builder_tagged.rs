...
pub mod builder {
    ...
    impl<'a> InstanceIssueCrucibleSnapshotRequest<'a> {
        ...
        #[doc = "Sends a `POST` request to `/instance/disk/{id}/snapshot/{snapshot_id}`"]
